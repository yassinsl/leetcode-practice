...
/*   Updated: 2024/12/21 07:22:59 by ylahssin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_count_word(char *word, char c)
{
	int	is_word;
	int	count;
...
static char	**ft_allocate_result(char *s, char c)
{
	char	**result;
	int		total_word;
...
static int	ft_fill_result(char **result, char *s, char c)
{
	char	*str;
	char	*start;
	int		pos;
